service Service {
  ...
  entity ChildEntity {
    key ID                    : Integer @title: 'Item Identifier';
        ...
        GrandChildEntity      : Association to many GrandChildEntity
                                on GrandChildEntity.Parent = $self;
    ...
    key ID                    : Integer @title: 'Item Identifier';
        ...
        TextProperty          : String  @title: 'Text';
        PropertyWithValueHelp : String  @title: 'With Value Help';
        Parent                : Association to ChildEntity;
  ...
  @(
    ...
    annotate GrandChildEntity with @(UI: {
    HeaderInfo    : {
      TypeName      : 'Grand Child Entity',
      TypeNamePlural: 'Grand Child Entities',
      Title         : {
        $Type: 'UI.DataField',
        Value: ID
      }
